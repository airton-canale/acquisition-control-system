...
public class Menu {
    ...
    public void adicionarUsuariosEDepartamentos() {
        listaUsuario.add(new Funcionario(1, "RH", "fulano1", "f1", "Admin"));
        listaUsuario.add(new Funcionario(2, "RH", "fulano2", "f2", "Funcionário"));
        listaUsuario.add(new Funcionario(3, "RH", "fulano3", "f3", "Funcionário"));
        listaUsuario.add(new Funcionario(4, "Financeiro", "fulano4", "f4", "Admin"));
        listaUsuario.add(new Funcionario(5, "Financeiro", "fulano5", "f5", "Admin"));
